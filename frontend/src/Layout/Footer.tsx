      ...
      <footer className="govuk-footer" role="contentinfo">
        <div className="govuk-width-container">
          <svg xmlns="http://www.w3.org/2000/svg"
            ...
            <g>
              <circle cx="20" cy="17.6" r="3.7"></circle><circle cx="10.2" cy="23.5" r="3.7"></circle><circle cx="3.7" cy="33.2" r="3.7"></circle><circle cx="31.7" cy="30.6" r="3.7"></circle><circle cx="43.3" cy="17.6" r="3.7"></circle><circle cx="53.2" cy="23.5" r="3.7"></circle><circle cx="59.7" cy="33.2" r="3.7"></circle><circle cx="31.7" cy="30.6" r="3.7"></circle>
          ...
          <div className="govuk-footer__meta">
            <div className="govuk-footer__meta-item govuk-footer__meta-item--grow">
              ...
              <p className="govuk-footer__body">
                Built by the
                <a className="hover govuk-footer__link"
                  href="https://www.gov.uk/government/organisations/department-for-transport"
                  target="_blank"
                  rel="noreferrer">Department for Transport</a>
              </p>
              ...
              <span className="govuk-footer__licence-description">
                ...
                <a className="govuk-footer__link"
                  ...
                  rel="noreferrer">Open Government Licence v3.0</a>, except where otherwise stated
              </span>
